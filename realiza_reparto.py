...
class realiza_reparto(models.Model): # Repartidor_Tiene_ContratoReparto(...) en documentación
  ...
  name = fields.Integer('Nº de Reparto', help='Este es el numero de orden de reparto', required=True, translate=False)
  CIF_rep = fields.Many2many('repartidor.contrato')
